  ...
  <div class="wrapper presentation-page">
    <div class="page-header clear-filter">
      ...
      <div class="rellax-text-container rellax-text">
        <h3 class="h1-seo" data-rellax-speed="-2">Contas</h3>
        <div class="pro">a pagar</div>
      </div>
      <h3 class="h3-description rellax-text" data-rellax-speed="-1">Gestão inteligente de despesas
        <parallax>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <h5 class="title">Contas a pagar</h5>
            <div class="card">
...
<script>
import {Button, Card, InfoSection} from '@/components';
